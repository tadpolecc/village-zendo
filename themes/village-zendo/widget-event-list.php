	...
	<ul <?php echo $id; ?> class="<?php echo esc_attr($classes);?>" > 
		...
		<?php while( $eo_event_loop->have_posts() ): $eo_event_loop->the_post(); ?>
			...
			<li class="<?php echo esc_attr(implode(' ',$eo_event_classes)); ?>" >
				<span class="upcoming-date"><?php echo __('','eventorganiser') . ''.eo_get_the_start($format); ?></span><br />
				<span class="upcoming-title"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_title(); ?></a></span>
			</li>
